  ...
  return (
    <div className="relative flex h-[130px] w-full items-center overflow-hidden rounded-[16px] text-white">
      ...
      <div className="relative z-10 flex h-[97px] w-[277px] flex-col justify-center px-[16px] py-[16px]">
        ...
        <button className="mt-[8px] w-max rounded-[120px] bg-[#FFFFFF]/30 px-[12px] py-[8px] text-[11px] font-bold text-white backdrop-blur-sm transition-colors hover:bg-white/40 active:scale-95">
          Daftar Sekarang
        </button>
      </div>
    </div>
